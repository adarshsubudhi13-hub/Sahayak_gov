...
import { DocumentVaultPage } from './pages/DocumentVaultPage.jsx';
...
function AppInner() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      ...
      {/* Accessibility Bar & System Banners — top of page */}
      <AccessibilityBar />
      <OfflineBanner />
      ...
      <AppErrorBoundary>
        <Routes>
          ...
          <Route path="/applications"       element={<ProtectedRoute><RouteErrorBoundary><ApplicationTrackerPage /></RouteErrorBoundary></ProtectedRoute>} />
          <Route path="/vault"              element={<ProtectedRoute><RouteErrorBoundary><DocumentVaultPage /></RouteErrorBoundary></ProtectedRoute>} />
